...
const ImageUploadComponent = ({ node, updateAttributes }) => {
  ...
  return (
    <NodeViewWrapper>
      {isPlaceholder ? (
        <div
          className="border-2 border-dashed border-gray-400 p-4 text-center cursor-pointer bg-gray-100 hover:bg-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-300"
          onClick={handleClick}
        >
